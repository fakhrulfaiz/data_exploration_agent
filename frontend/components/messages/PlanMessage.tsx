        ...
        <div className="px-4 pb-3 pl-12 mt-2 space-y-3 animation-fade-in">
          ...
          {step.requires && (
            <div className="flex gap-2 text-xs text-muted-foreground bg-amber-500/5 border border-amber-500/20 p-2.5 rounded-md">
              ...
              <div>
                <span className="font-medium text-amber-700/80 mr-1">
                  Requires:
                </span>
                {step.requires}
              </div>
...
export const PlanMessage: React.FC<PlanMessageProps> = ({
  ...
  // If this is a replan approval, render the replan UI
  if (isReplan && needsApproval) {
    return (
      <div className="border border-amber-500/50 bg-amber-500/5 rounded-lg p-4 shadow-sm">
        {/* Header */}
        <div className="flex items-center gap-2 mb-3">
          ...
          {replanCount > 0 && (
            <span className="text-xs bg-amber-200 dark:bg-amber-900 text-amber-800 dark:text-amber-200 px-2 py-0.5 rounded">
        ...
        <div className="mb-4 p-3 bg-background border border-border rounded-md">
          ...
          <p className="text-sm text-foreground">
            {feedback || "An error occurred during execution."}
          </p>
        </div>
        ...
        <div className="mb-4 text-sm text-muted-foreground">
          ...
          <ul className="space-y-1 ml-4">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong>Replan:</strong> The agent will create a new plan using
                this feedback
              </span>
            </li>
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong>Show Results:</strong> Display any partial results
                collected so far
              </span>
            </li>
          </ul>
  ...
  // Regular plan rendering (original code)
